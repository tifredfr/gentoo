...
# $Header: /var/cvsroot/gentoo-x86/media-libs/mesa/mesa-7.2.ebuild,v 1.1 2008/09/21 00:49:28 dberkholz Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/7.2/01_disable-intel-classic-warn.diff" || die "patch failed"
	epatch "${FILESDIR}/7.2/102_dont_vblank.patch" || die "patch failed"
