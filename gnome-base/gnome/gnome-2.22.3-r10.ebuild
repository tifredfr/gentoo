...
RDEPEND="
	...
	>=x11-libs/libwnck-2.22.3
	>=x11-wm/metacity-2.22.0

	>=gnome-base/gnome-keyring-2.22.3
	>=app-crypt/seahorse-2.22.3
	...
	>=gnome-base/gvfs-0.2.5
	>=gnome-base/eel-2.22.2
	>=gnome-base/nautilus-2.22.4
	...
	accessibility? (
		...
		>=app-accessibility/gnome-speech-0.4.20
		>=app-accessibility/gok-1.3.7
		>=app-accessibility/orca-2.22.3
		>=gnome-extra/mousetweaks-2.22.3 )
